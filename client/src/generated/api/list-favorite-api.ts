 ...
 * @export
 */
export const ListFavoriteApiAxiosParamCreator = function (
...
export const ListFavoriteApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    ListFavoriteApiAxiosParamCreator(configuration);
  return {
    /**
     * List Favorite
     * @summary List Favorite
    ...
    > {
      ...
      const localVarOperationServerBasePath =
        operationServerMap["ListFavoriteApi.listFavorite"]?.[
 ...
 * @export
 */
export const ListFavoriteApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
...
export class ListFavoriteApi extends BaseAPI {
  ...
  public listFavorite(options?: RawAxiosRequestConfig) {
    return ListFavoriteApiFp(this.configuration)
      .listFavorite(options)
