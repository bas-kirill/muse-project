...
export const GetInstrumentByIdApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getInstrumentById: async (instrumentId: number, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export const GetInstrumentByIdApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getInstrumentById(instrumentId: number, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<InstrumentDetail>> {
...
export const GetInstrumentByIdApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getInstrumentById(instrumentId: number, options?: RawAxiosRequestConfig): AxiosPromise<InstrumentDetail> {
...
export class GetInstrumentByIdApi extends BaseAPI {
     ...
     */
    public getInstrumentById(instrumentId: number, options?: RawAxiosRequestConfig) {
