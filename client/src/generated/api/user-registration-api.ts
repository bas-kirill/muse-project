 ...
 * @export
 */
export const UserRegistrationApiAxiosParamCreator = function (
...
export const UserRegistrationApiFp = function (configuration?: Configuration) {
  const localVarAxiosParamCreator =
    UserRegistrationApiAxiosParamCreator(configuration);
  return {
    /**
     * Register User
     * @summary User Registration
    ...
    > {
      const localVarAxiosArgs =
        await localVarAxiosParamCreator.userRegistration(
          registrationRequest,
          options,
        );
      const localVarOperationServerIndex = configuration?.serverIndex ?? 0;
      const localVarOperationServerBasePath =
        operationServerMap["UserRegistrationApi.userRegistration"]?.[
 ...
 * @export
 */
export const UserRegistrationApiFactory = function (
  configuration?: Configuration,
  basePath?: string,
  axios?: AxiosInstance,
) {
  ...
  return {
    ...
    userRegistration(
      ...
      return localVarFp
        .userRegistration(registrationRequest, options)
...
export class UserRegistrationApi extends BaseAPI {
  ...
  public userRegistration(
    ...
    return UserRegistrationApiFp(this.configuration)
      .userRegistration(registrationRequest, options)
