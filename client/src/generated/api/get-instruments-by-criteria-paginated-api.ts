...
export const GetInstrumentsByCriteriaPaginatedApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         */
        getInstrumentsByCriteriaPaginated: async (pageSize: number, pageNumber: number, getInstrumentCriteriaRequestBody: GetInstrumentCriteriaRequestBody, options: RawAxiosRequestConfig = {}): Promise<RequestArgs> => {
            ...
            assertParamExists('getInstrumentsByCriteriaPaginated', 'getInstrumentCriteriaRequestBody', getInstrumentCriteriaRequestBody)
...
export const GetInstrumentsByCriteriaPaginatedApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async getInstrumentsByCriteriaPaginated(pageSize: number, pageNumber: number, getInstrumentCriteriaRequestBody: GetInstrumentCriteriaRequestBody, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<GetInstrumentByCriteriaPageResponse>> {
            const localVarAxiosArgs = await localVarAxiosParamCreator.getInstrumentsByCriteriaPaginated(pageSize, pageNumber, getInstrumentCriteriaRequestBody, options);
...
export const GetInstrumentsByCriteriaPaginatedApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        getInstrumentsByCriteriaPaginated(pageSize: number, pageNumber: number, getInstrumentCriteriaRequestBody: GetInstrumentCriteriaRequestBody, options?: RawAxiosRequestConfig): AxiosPromise<GetInstrumentByCriteriaPageResponse> {
            return localVarFp.getInstrumentsByCriteriaPaginated(pageSize, pageNumber, getInstrumentCriteriaRequestBody, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class GetInstrumentsByCriteriaPaginatedApi extends BaseAPI {
     ...
     */
    public getInstrumentsByCriteriaPaginated(pageSize: number, pageNumber: number, getInstrumentCriteriaRequestBody: GetInstrumentCriteriaRequestBody, options?: RawAxiosRequestConfig) {
        return GetInstrumentsByCriteriaPaginatedApiFp(this.configuration).getInstrumentsByCriteriaPaginated(pageSize, pageNumber, getInstrumentCriteriaRequestBody, options).then((request) => request(this.axios, this.basePath));
    }
}
